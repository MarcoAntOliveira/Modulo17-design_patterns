"""
Abstract Factory e um padrao de criacao que fornece uma interface para criar
...
Uma diferenca importante entre Factory Method e Abstract Factory e que o
Factory Method usa heranca, enquanto Abstract Factory usa a composicao.

Principio: programe para interfaces, nao para implementacoes
"""
